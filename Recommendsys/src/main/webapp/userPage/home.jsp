...
<div class="blog-body">
    ...
    <div class="blog-container">
        <div class="blog-main">
            <!--        轮播-->
            <div class="layui-carousel" id="home-carousel" style="margin-top: 15px;height: 200px;width: 100%">
            ...
            <div class="blog-main-right">
                ...
                <div class="blog-module shadow">
                    <div class="blog-module-title">热门店铺排行</div>
                    <ul class="fa-ul blog-module-ul" id="hotRestaurant">
                    </ul>
                </div>
                <div class="blog-module shadow">
